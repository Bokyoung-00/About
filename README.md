...
[관리자 역할]
1. 수입지출월별정리 : 결제 후 영수증처리, 엑셀 파일에 월 매출과 지출 내역을 정리하여 월말 보고 담당 [사용 함수 및 기능: SUM(), COUNTIF(), Pivot Table(), Vlookup(), Hlookup(), 데이터 유효성 검사 등...]
...
4. HRM : 새로운 아르바이트 생 교육과 평가 후 엑셀로 보고

5. Management : 학원에 필요한 비품과 이벤트 용품 주문. 음원 파일 및 도서 관리. 엑셀 파일을 새로 만들어 책제목 검색을 통해 책 위치를 찾을 수 있도록 함. 

6. 이벤트 기획 : 월 별 이벤트를 기획해 학생 출석률을 높임. eg) 출석 이벤트, 할로윈 이벤트, 북리포트 이벤트 등...
