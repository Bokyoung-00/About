...
- 1.1만회의 조회수 기록하며 가장 높은 조회수 기록 
 ...
 ![2017.6 과방라이브](picture/live.jpg)
#### 3.  [ 2016.12 과방 라이브](https://www.facebook.com/hufsmedia/videos/1214934621949871/) 
...
![이노블스](picture/enovels.jpg)

(주) 바질레이 에서 (주) 이노블스로 상호 변경
- 2017.8- 2018.2 (주) 바질레이 이챕터스 실장 (아르바이트)
- 2019.3- 2020.6 (주) 이노블스 실장 (정직원)

[관리자 역할]
1. 수입지출월별정리 - 결제 후 영수증처리, 엑셀 파일에 월 매출과 지출 내역을 정리하여 월말 보고 담당

2. CRM - 카카오 채널 관리자와 전화 채널로 학부모 예약 및 관리.
재등록 기간 학생의 포트폴리오를 제작하여 상담 일정을 잡고, 등록 유도. 
컴플레인을 받으면 정리해 원장님께 보고 후 해결

3. 학생 관리 - 학생이 빠진 부분 없이 수업 하고 하원하는지, 불편한 점 없도록 관리

4. 학원 관리 - 학원에 필요한 비품과 이벤트 용품 주문. 새로운 아르바이트 생 교육. 숙달 전에는 책을 찾기 어려웠던 점을 해결하기 위해 선반 별로 번호를 매기고 엑셀에 책 이름을 정리해 검색 기능을 통해 빠르게 책을 찾을 수 있도록 만듬.

5. 이벤트 기획 - 월 별 이벤트를 기획해 학생 출석률을 높임. eg) 출석 이벤트, 할로윈 이벤트, 북리포트 이벤트 등...
